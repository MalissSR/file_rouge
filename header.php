...
<html lang="fr">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg col-12">
        ...
        <img src="images_the_district/the_district_brand/logo_transparent.png" alt="logo" class="col-1 d-none d-lg-flex">
        <img src="images_the_district/the_district_brand/logo_transparent.png" alt="logo" class="col-3  d-sm-flex d-md-none d-lg-none">
        <img src="images_the_district/the_district_brand/logo_transparent.png" alt="logo" class="col-3   d-none d-md-flex d-lg-none">
